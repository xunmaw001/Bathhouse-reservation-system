<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="信誉分" prop="xinyufen">
          <el-input v-model="ruleForm.xinyufen" 
              placeholder="信誉分" clearable  :readonly="ro.xinyufen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="信誉分" prop="xinyufen">
              <el-input v-model="ruleForm.xinyufen" 
                placeholder="信誉分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
